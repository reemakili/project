...
class ListInfo extends StatelessWidget {
  static const String routeName = "ListInfo";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Produits informatiques',
        style: TextStyle(
          color: Colors.white,
          fontSize: 20,
        ),),
      ),
      body: FutureBuilder<QuerySnapshot<InfoModel>>(
        future: DBService().getData(),
  ...
  void _showProductDetailsPopup(BuildContext context, InfoModel product) {
    showDialog(
      context: context,
