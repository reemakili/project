...
class ListBag extends StatelessWidget {
  static const String routeName = "ListBag";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Bagageries',
          style: TextStyle(
            color: Colors.white,
            fontSize: 20,
          ),),
      ),
      body: FutureBuilder<QuerySnapshot<BagModel>>(
        future: DBService().getBagData(),
  ...
  void _showProductDetailsPopup(BuildContext context, BagModel product) {
    showDialog(
      context: context,
